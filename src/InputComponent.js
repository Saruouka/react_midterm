      ...
      <div className="test">
          ...
          <div className="row App-box">
              ...
              <div className="col-md-6 App-content">
                    ...
                    GPAX (ไม่เกิน 4.00)
                    <center><input type="number" min="1" max="4" required onChange={this.GetGpax} placeholder="GPAX" className="form-test"/></center>
                    Onet (คะแนนเต็ม 100)
                    <center>
                        <input type="number" onChange={this.GetOnet01} placeholder="01 ภาษาไทย" className="form-test"/>
                        <input type="number" onChange={this.GetOnet02} placeholder="02 สังคม" className="form-test"/>
                        <input type="number" onChange={this.GetOnet03} placeholder="03 ภาษาอังกฤษ" className="form-test"/>
                        <input type="number" onChange={this.GetOnet04} placeholder="04 คณิตศาสตร์" className="form-test"/>
                        <input type="number" onChange={this.GetOnet05} placeholder="05 วิทยาศาสตร์" className="form-test"/>
                    </center>
                    GAT (คะแนนเต็ม 300)
                    <center><input type="number" onChange={this.GetGat} placeholder="GAT" className="form-test"/></center>
                </div>
                <div className="col-md-6 App-content">
                    PAT (คะแนนเต็ม 300)
                    <center>
                        <input type="number" onChange={this.GetPat01} placeholder="PAT1 คณิตศาสตร์" className="form-test"/>
                        <input type="number" onChange={this.GetPat02} placeholder="PAT2 วิทยาศาสตร์" className="form-test"/>
                        <input type="number" onChange={this.GetPat03} placeholder="PAT3 วิศวกรรม" className="form-test"/>
                        <input type="number" onChange={this.GetPat04} placeholder="PAT4 สถาปัตยกรรม" className="form-test"/>
                        <input type="number" onChange={this.GetPat05} placeholder="PAT5 วิชาชีพครู" className="form-test"/>
                        <input type="number" onChange={this.GetPat06} placeholder="PAT6 ศิลปกรรม" className="form-test"/>
                        <input type="number" onChange={this.GetPat07} placeholder="PAT7 ความถนัดทางภาษา" className="form-test"/>
                    </center>
                </div>
                <div className="col-md-12 App-content">
                <button type="button" onClick={this.ScoreCalc} className="btn-primary">คำนวณ</button>
                <br/>
              </div>
              </form>
          </div>
